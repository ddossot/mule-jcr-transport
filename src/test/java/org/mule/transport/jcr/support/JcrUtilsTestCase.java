...
public class JcrUtilsTestCase extends AbstractMuleTestCase {
    ...
    private final Object[] supportedValues = new Object[] { Boolean.TRUE, Calendar.getInstance(), new Double(3.14d),
            new ByteArrayInputStream("foo".getBytes()), "bar".getBytes(), new Long(123), "baz" };
    ...
    public void testSimplePropertyValues() throws Exception {
        for (int i = 0; i < supportedValues.length; i++) {
            ...
            final Object retrievedValue = JcrPropertyUtils.getValuePayload(JcrPropertyUtils.newPropertyValue(session,
                    supportedValue));
