...
public class NodeTypeHandlersTest extends AbstractMuleTestCase {
	...
	public void testAll() throws Exception {
		...
		final Node defaultNode = nodeTypeManager.getChildNodeTypeHandler(
				testDataNode).createNode(session, testDataNode, "defaultNode",
		...
		msg = new DefaultMuleMessage(fileContentNode);
		...
		nodeTypeManager.getNodeTypeHandler(folderNode).updateContent(session,
				folderNode, new DefaultMuleMessage(IGNORED_FOLDER_CONTENT));
