...
public final class JcrConnector extends AbstractConnector {
	...
	/**
	 * Property that defines a the full unique path of a particular item (node
	 * or property).
	 */
	...
	public OutputStream getOutputStream(final OutboundEndpoint endpoint,
		...
		final Thread thread = new Thread(new Runnable() {
			public void run() {
				try {
					endpoint.process(new DefaultMuleEvent(
							new DefaultMuleMessage(pipedInputStream, message,
